...
export default function EventHighlights() {
  ...
  return (
    ...
    >
      {/* Decorative blobs */}
      <div
        className="absolute top-20 -left-32 w-64 h-64 rounded-full blur-3xl pointer-events-none"
        style={{ backgroundColor: "var(--bg-tertiary)", opacity: 0.5 }}
      />
      <div
        className="absolute bottom-20 -right-32 w-64 h-64 rounded-full blur-3xl pointer-events-none"
          ...
          <TiltCard className="w-full">
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{
                  boxShadow:
                    "0 30px 80px rgba(0,0,0,0.5), 0 0 40px rgba(139,92,246,0.08)",
                }}
              >
                <div className="flex flex-col md:flex-row">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                      <div
                        className="absolute top-0 left-1/4 w-80 h-80 rounded-full blur-[100px]"
                        style={{ backgroundColor: "rgba(139,92,246,0.15)" }}
                      />
                      <div
                        className="absolute bottom-0 right-1/4 w-60 h-60 rounded-full blur-[80px]"
                        style={{ backgroundColor: "rgba(245,158,11,0.08)" }}
                      />
                      <div
                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-40 rounded-full blur-[120px]"
                    ...
                    <div className="relative z-10 p-6 md:pl-12 md:pr-8 md:py-8">
                      ...
                      <div className="mb-6">
                        ...
                        <h3
                          className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl leading-[0.95]"
                          style={{ color: "#F59E0B" }}
                        >
                          FRESHERS
                        </h3>
                  ...
                  <div
                    className="relative md:hidden flex items-center justify-center py-0"
                    style={{ backgroundColor: "#0f0f12" }}
                  >
                    {/* Left notch */}
                    <div
                  ...
                  >
                    ...
                    {/* Event name */}
                    <p
                      className="font-heading font-bold text-sm mb-0.5 relative z-10"
                      style={{ color: "#ffffff" }}
                    >
                      SVCE
                    </p>
                    ...
                    <p
                      className="font-heading font-bold text-3xl mb-4 relative z-10"
                      style={{ color: "#F59E0B" }}
                    >
                      2026
                    </p>
                      ...
                      <div className="w-full h-full grid grid-cols-7 gap-[1px]">
                        {Array.from({ length: 49 }).map((_, i) => {
                          const pattern = [
                            ...
                            48, 8, 9, 10, 11, 12, 15, 16, 19, 22, 23, 26, 29,
                            30, 33,
                          ];
                          return (
                            <div
                              ...
                              style={{
                                backgroundColor: pattern.includes(i)
                                  ? "#0f0f12"
                                  : "#e5e5e5",
                              }}
                            />
                    ...
                    <p
                      className="text-[8px] font-semibold tracking-[0.2em] uppercase mb-5 relative z-10"
                      style={{ color: "rgba(255,255,255,0.3)" }}
                    >
                      SCAN TO VERIFY
                    </p>
