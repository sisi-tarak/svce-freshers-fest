    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          {/* Event Entry Card */}
          <div
            className="relative rounded-2xl overflow-hidden border transition-all duration-300 card-hover-orange"
            style={{
          ...
          >
            ...
            <div className="p-7">
              ...
              {/* Price */}
              <div className="mb-6">
                <span className="text-5xl font-heading font-bold text-accent-orange">
                  &#8377;{TICKET_PRICE}
                </span>
                <span
              ...
              <p
                ...
                style={{ color: "var(--text-muted)" }}
              >
                *SVCE students: &#8377;{TICKET_PRICE} or Free — subject to
          ...
          <div
            className="relative rounded-2xl overflow-hidden border transition-all duration-300 card-hover-cyan"
            style={{
              backgroundColor: "var(--bg-secondary)",
              borderColor: "var(--border-default)",
            }}
          >
            {/* Top gradient bar — amber */}
            <div
              className="h-1"
              style={{
            ...
            <div className="p-7">
              ...
              {/* Price */}
              <div className="mb-6">
                <span className="text-5xl font-heading font-bold text-accent-cyan">
                  +&#8377;{HACKATHON_FEE}
                </span>
                <span
                  className="text-sm ml-2"
        ...
        >
          <h3
            className="font-heading font-semibold text-center mb-6"
            style={{ color: "var(--text-primary)" }}
          >
            How It Works
          </h3>
        ...
        >
          <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
            Have a referral code from a Campus Ambassador? Enter it during
            registration on Ticket9 for them to earn rewards.
          </p>
        </motion.div>
