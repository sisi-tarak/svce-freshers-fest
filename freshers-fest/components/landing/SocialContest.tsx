...
export default function SocialContest() {
  ...
  return (
    <section className="section-padding relative overflow-hidden" style={{ backgroundColor: 'var(--bg-primary)' }} ref={ref}>
      <div className="absolute top-20 right-0 w-72 h-72 rounded-full blur-3xl pointer-events-none" style={{ backgroundColor: 'var(--bg-tertiary)', opacity: 0.4 }} />
          ...
          >
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex gap-3 items-start">
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold shrink-0" style={{ backgroundColor: 'var(--bg-tertiary)', color: 'var(--text-primary)', border: '1px solid var(--border-default)' }}>
                    {i + 1}
                  </span>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-start gap-3">
                <Eye className="w-5 h-5 shrink-0 mt-0.5" style={{ color: 'var(--text-secondary)' }} />
                <div>
              ...
              <div className="flex items-start gap-3">
                <Gift className="w-5 h-5 shrink-0 mt-0.5" style={{ color: 'var(--text-secondary)' }} />
                <div>
